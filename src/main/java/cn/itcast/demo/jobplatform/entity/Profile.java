...
public class Profile extends BaseEntity {
    ...
    public void setAvatarPath(String value) { this.avatarPath = value; }
    /** 城市。 */
    private String city;
    ...
    public void setDiscoverable(Boolean value) { this.discoverable = value; }
    /** 公司名称。 */
    ...
    public void setCompanyDescription(String value) { this.companyDescription = value; }
    /** 审核状态。 */
    private String reviewStatus;
    public String getReviewStatus() { return reviewStatus; }
    public void setReviewStatus(String value) { this.reviewStatus = value; }
    /** 审核原因。 */
