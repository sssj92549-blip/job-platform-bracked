...
public class Application extends BaseEntity {
    ...
    public void setProfileSource(String value) { this.profileSource = value; }

    /** 不可变简历快照，含原填、AI、确认、冲突、全文。 */
    private String resumeSnapshot;
    public String getResumeSnapshot() { return resumeSnapshot; }
    public void setResumeSnapshot(String value) { this.resumeSnapshot = value; }

    /** 不可变职位及公司展示快照。 */
    private String jobSnapshot;
    public String getJobSnapshot() { return jobSnapshot; }
    public void setJobSnapshot(String value) { this.jobSnapshot = value; }
}
