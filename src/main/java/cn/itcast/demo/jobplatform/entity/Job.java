...
public class Job extends BaseEntity {
    ...
    public void setSalaryMin(Integer value) { this.salaryMin = value; }

    /** 最高月薪，元。 */
    private Integer salaryMax;
    public Integer getSalaryMax() { return salaryMax; }
    public void setSalaryMax(Integer value) { this.salaryMax = value; }
    ...
    public void setExperienceMinYears(Integer value) { this.experienceMinYears = value; }
    ...
    public void setRequirements(String value) { this.requirements = value; }

    /** 技能字符串数组，允许[]。 */
    private String skills;
    public String getSkills() { return skills; }
    public void setSkills(String value) { this.skills = value; }
    ...
    public void setReviewReason(String value) { this.reviewReason = value; }
