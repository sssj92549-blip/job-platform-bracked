...
public class TalentController {
    ...
    public ResponseEntity<?> search(@PathVariable Long id, @Valid @RequestBody Talent input, HttpServletRequest request) {
        return ResponseEntity.status(200).body(ApiResponse.success(service.search(id, input, request)));
    }
}
