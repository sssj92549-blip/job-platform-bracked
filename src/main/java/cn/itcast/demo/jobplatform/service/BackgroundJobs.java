...
public class BackgroundJobs {
    ...
    public BackgroundJobs(JobVectorService jobVectors, ResumeService resumes, AiTaskService ai, VectorSyncService vectors, @Value("${app.jobs.enabled:true}") boolean enabled) {
        this.jobVectors = jobVectors;
    ...
    private void run(Runnable work) {
        ...
        try {
            ...
            LoggerFactory.getLogger(getClass()).error("Background task failed: {}", e.getClass().getSimpleName());
        }
    }
}
