...
public class LoginGuard {
    ...
    public LoginGuard(StringRedisTemplate redis) { this.redis=redis; }
    ...
    public void rateLimit(String ip) {
        ...
        if(n==null || n>120) throw new BusinessException(HttpStatus.TOO_MANY_REQUESTS,42902,"请求过于频繁，请稍后再试");
    }
    ...
    public void succeeded(String key) { redis.delete(key); }
